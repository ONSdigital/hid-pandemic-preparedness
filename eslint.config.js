...
export default [
  ...
  ...eslintPluginAstro.configs["flat/recommended"], // Accessibility rules extended for Astro components
  ...eslintPluginAstro.configs["flat/jsx-a11y-recommended"], // Override for .astro files specifically
  {
    files: ["**/*.astro"],
    languageOptions: {
      parser: astroParser,

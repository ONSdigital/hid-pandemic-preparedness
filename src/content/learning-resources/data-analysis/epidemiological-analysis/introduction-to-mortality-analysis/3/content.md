...
1. Factors Contributing to Longer Delays
...
**Exceptional cases:** Registration may be delayed in rare circumstances, suchas:
...
A cause of deathrefers to the disease, condition, or injury that initiated the sequence of events leading directly to death. Causes of death are recorded on the death certificate and coded using the International Classification of Diseases).
...
Mean age at death = (Σ (aᵢ × dᵢ)) / d Copy
Where:
aᵢ = age i + 0.5
...
Crude YLL rate = (YLLᵢ / P) × 100,000 Copy
...
| dx                 | Probability of dying between age x and x+1                                                              |
| lx                 | Number of survivors to exact age x from a cohort of 100,000 live births                                 |
...
1. Calculate qₓ using observed mortality rates. For ages 1 and above:
   qₓ = (2⋅mₓ) / (2 + mₓ)
